...
import { Maximize2, Minimize2, X, FileOutput } from 'lucide-react';
            ...
            <div className="flex items-center justify-between p-4 border-b border-zinc-200 dark:border-zinc-700 bg-gradient-to-r from-zinc-50 to-white dark:from-zinc-800 dark:to-zinc-800">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-xl bg-zinc-100 dark:bg-zinc-700">
                  <FileOutput className="h-5 w-5 text-zinc-600 dark:text-zinc-400" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Current Output</h3>
                  <span className="text-xs text-zinc-400">{currentOutput.length} chars</span>
                </div>
              </div>
